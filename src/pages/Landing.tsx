    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center px-4 py-12">
      ...
      <div className="mb-8">
        <Avatar className="w-32 h-32 border-4 border-white shadow-lg">
          <AvatarImage
            src="https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?crop=entropy&cs=tinysrgb&fit=crop&w=500&h=500"
            alt="Ummi Salamah"
          />
      ...
      <div className="flex flex-col gap-4 w-full max-w-md mb-8">
        <Button 
          variant="outline" 
          className="w-full h-auto py-4 px-6 bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 shadow-sm hover:shadow transition-all duration-300"
          onClick={() => window.open("https://amahdigital.blogspot.com/", "_blank")}
        >
        ...
        <Button 
          variant="outline"
          className="w-full h-auto py-4 px-6 bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 shadow-sm hover:shadow transition-all duration-300"
          onClick={() => window.open("https://amahdigital.blogspot.com/p/gratis.html", "_blank")}
        >
          Produk Gratis
        </Button>
        ...
        <Button 
          variant="outline"
          className="w-full h-auto py-4 px-6 bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 shadow-sm hover:shadow transition-all duration-300"
          onClick={() => window.open("https://riyanputra.id/aff/1162/10158/", "_blank")}
        >
